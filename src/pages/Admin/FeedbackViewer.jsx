              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold transition-all ${
                  filter === f
                    ...
                    : "bg-slate-100 dark:bg-night-100 text-ink-ghost dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-night-50"
                }`}
              >
                {f === "bug" ? (
            ...
            {items.map((item, i) => (
              <ScrollReveal key={item.id} delay={`${Math.min(i * 0.05, 0.3)}s`}>
                ...
                >
                  ...
                  {item.steps && (
                    <div className="mt-3 bg-slate-50 dark:bg-night-100 rounded-xl p-3 text-xs text-ink-ghost dark:text-slate-400">
